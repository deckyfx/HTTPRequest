...
/**
 * Master of DAO (schema version 1709251618): knows all DAOs.
 */
public class DaoMaster extends AbstractDaoMaster {
    public static final int SCHEMA_VERSION = 1709251618;
    ...
    public static class DevOpenHelper extends OpenHelper {
        ...
        public void onDowngrade(Database db, int oldVersion, int newVersion) {
            /** WARNING: do not implement this if you don;t want to downgrade schema */
